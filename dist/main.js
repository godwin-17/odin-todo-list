...
function getTodayTodos() {
  ...
  project.forEach(p => {
    const todo = p.todos;
    todo.forEach(t => {
      console.log((0,date_fns__WEBPACK_IMPORTED_MODULE_8__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(t.date)));
